...
light_theme_css = """
    ...
    .stButton button { background:  linear-gradient(to left, #43DDE6, #FF77B7); color: white; border-radius: 8px; }
...
def handle_query():
    ...
    "Hello, I am **Lumina** (light and intelligence), an AI chatbot.<br><hr>"
